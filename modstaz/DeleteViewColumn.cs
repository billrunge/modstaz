...
namespace modstaz
{
    public static class DeleteViewColumn
    {
        [FunctionName("DeleteViewColumn")]
            ...
            ILogger log)
        {
            ...
            if (jwtResp != "false")
            {
                ...
                return (ActionResult)new OkObjectResult(await view.DeleteViewColumnAsync(viewId, columnId));
            }
